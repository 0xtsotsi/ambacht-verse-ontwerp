...
export const ServiceTierCalculator = memo<ServiceTierCalculatorProps>(
  ({ tier, serviceCategory, guestCount: initialGuestCount, onPriceChange }) => {
    ...
    const calculatePricing = useCallback(
      (guests: number, tierMultiplier: number, basePrice: number) => {
        const baseTotal = basePrice * tierMultiplier * guests;

        // Find applicable volume discount
        const discount = VOLUME_DISCOUNTS.filter(
          (d) => guests >= d.minGuests,
        ).reduce(
          (max, current) => (current.discount > max.discount ? current : max),
          { discount: 0, minGuests: 0, label: "" },
        );
          ...
          <CardContent className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center space-x-2">
                ...
                />
                <span className="text-xs text-natural-brown">
                  min. 1, max. 500
                </span>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              {showDetails && (
                <div className="space-y-3 p-4 bg-forest-green/5 rounded-lg border border-forest-green/10 animate-fadeIn">
                  <h4 className="font-medium text-forest-green text-sm">
                    Prijs Breakdown:
                  </h4>
                  ...
                  <div className="space-y-2 text-sm">
                    <div className="flex justify-between">
                      <span className="text-natural-brown">
                        Basis prijs ({serviceCategory.name})
                      </span>
                      <span data-testid="base-price" className="font-medium">
                    ...
                    <div className="flex justify-between">
                      <span className="text-natural-brown">
                        Service niveau multiplier
                      </span>
                      <span data-testid="multiplier" className="font-medium">
              ...
              <div className="flex items-start space-x-2">
                ...
                <div className="space-y-1">
                  ...
                  <ul className="space-y-1 list-disc list-inside">
                    ...
                    <li>
                      Finaal tarief kan variëren op basis van specifieke wensen
                    </li>

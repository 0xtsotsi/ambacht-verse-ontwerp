  ...
  return (
    <div data-testid="service-tier-comparison" className="space-y-6">
      <div className="text-center">
        <h3 className="text-xl font-serif text-forest-green mb-2">Gedetailleerde Vergelijking</h3>
          ...
          return (
            ...
            >
              ...
              <CardHeader className="pb-4">
                <CardTitle className="flex flex-col items-center text-center space-y-2">
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="text-xs text-natural-brown">per persoon</div>
              ...
              <CardContent className="space-y-4">
                {/* Features List */}
                <div>
                  <h4 className="font-medium text-forest-green mb-3 text-sm">Inbegrepen Services:</h4>
                  <ul className="space-y-2">
                    {tier.features.map((feature, featureIndex) => (
                      ...
                      >
                        ...
                        />
                        <span className={`${isSelected ? 'text-forest-green font-medium' : 'text-natural-brown'}`}>
                          {feature}
                        </span>
                      </li>
                    ))}
                ...
                <div className="pt-4 border-t border-beige/30">
                  ...
                  <ul className="space-y-2">
                    {serviceCategory.popularFeatures.slice(0, 2).map((feature, idx) => (
                ...
                `}>
                  ...
                  <div className="font-bold">
                    €{(serviceCategory.minPrice * tier.priceMultiplier * 10).toFixed(0)} 
      ...
      <div className="mt-8 p-6 bg-gradient-to-br from-forest-green/5 via-beige/5 to-accent/5 rounded-xl border border-beige/20">
        <h4 className="font-serif text-lg text-forest-green mb-4 text-center">Waarom Deze Indeling?</h4>
        
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
          <div className="text-center p-4 bg-white/50 rounded-lg">
            <div className="font-medium text-forest-green mb-2">Essential</div>
            <p className="text-natural-brown text-xs leading-relaxed">
              Perfect voor kleinere evenementen waar kwaliteit en efficiency voorop staan. 
              Alle essentials voor een geslaagd evenement.
            </p>
          </div>

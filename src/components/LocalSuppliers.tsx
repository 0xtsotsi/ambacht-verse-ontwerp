...
export const LocalSuppliers = () => {
  ...
  return (
    <section className="py-32 bg-gradient-to-b from-gray-50 to-white overflow-hidden relative" ref={sectionRef}>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-24">
            ...
            >
              ...
              <span className="text-terracotta-700 font-elegant-body font-medium">Lokale Samenwerking</span>
            </div>
            ...
            >
              <span className="inline-block transition-all duration-700 hover:scale-110 hover:-translate-y-2">ONZE</span>{' '}
              ...
              <span className="inline-block transition-all duration-700 hover:scale-110 hover:-translate-y-2">PARTNERS</span>
            </h2>
            ...
            {suppliers.map((supplier, index) => (
              ...
              >
                <div className="relative bg-white/90 backdrop-blur-sm rounded-3xl p-10 h-full hover:bg-white hover:shadow-elegant-panel transition-all duration-700 transform hover:scale-105 hover:-translate-y-3 border border-terracotta-200/30 overflow-hidden">
                  ...
                  <div className="absolute inset-0 -top-full -bottom-full bg-gradient-to-r from-transparent via-white/20 to-transparent w-full animate-interactive-shimmer opacity-0 group-hover:opacity-100" style={{ animationDelay: `${index * 0.2}s` }}></div>
          ...
          >
            ...
            <div className="max-w-3xl mx-auto relative z-10">
              ...
              <h3 className="text-5xl md:text-6xl font-elegant-heading text-white mb-8 font-light tracking-[-0.02em] transition-all duration-700 group-hover:scale-105">
                <span className="inline-block transition-all duration-700 hover:scale-110 hover:-translate-y-1">Minimale E-nummers,</span><br />
                <span className="text-terracotta-400 inline-block transition-all duration-700 hover:scale-110 hover:-translate-y-1">Maximale Smaak</span>
              </h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mt-12">
                <div className="text-center transform transition-all duration-500 hover:scale-110 hover:-translate-y-2 group/stat">
                  <div className="text-6xl font-elegant-heading text-terracotta-400 mb-3 font-light animate-interactive-pulse-glow">95%</div>
                  <div className="text-white/70 font-elegant-body font-light transition-all duration-500 group-hover/stat:text-white">Lokale Ingrediënten</div>
                </div>
                <div className="text-center transform transition-all duration-500 hover:scale-110 hover:-translate-y-2 group/stat" style={{animationDelay: '0.2s'}}>
                  <div className="text-6xl font-elegant-heading text-terracotta-400 mb-3 font-light animate-interactive-pulse-glow" style={{animationDelay: '0.4s'}}>0</div>
                  <div className="text-white/70 font-elegant-body font-light transition-all duration-500 group-hover/stat:text-white">Kunstmatige Kleurstoffen</div>
                </div>
                <div className="text-center transform transition-all duration-500 hover:scale-110 hover:-translate-y-2 group/stat" style={{animationDelay: '0.4s'}}>
                  <div className="text-6xl font-elegant-heading text-terracotta-400 mb-3 font-light animate-interactive-pulse-glow" style={{animationDelay: '0.8s'}}>100%</div>
                  <div className="text-white/70 font-elegant-body font-light transition-all duration-500 group-hover/stat:text-white">Verse Bereiding</div>
                </div>
              </div>
            </div>
          </div>

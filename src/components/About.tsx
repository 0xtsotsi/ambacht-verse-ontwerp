              ...
              <div className="flex items-center justify-center">
                <div className="max-w-lg text-center group cursor-pointer">
                  ...
                  <p 
                    ...
                    style={{
                      opacity: textAnimation ? 1 : 0,
                      transform: textAnimation ? 'translateY(0)' : 'translateY(20px)',
          ...
          <div className="max-w-6xl mx-auto text-center">
            ...
            <div>
              <h3 
                ...
                style={{
                  opacity: textAnimation ? 1 : 0,
                  transform: textAnimation ? 'translateY(0)' : 'translateY(30px)',
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-24">
                {[
                  { name: "KAASBOERDERIJ", subtitle: "VAN SCHAIK", delay: "1.4s" },
                  { name: "BAKKERIJ", subtitle: "VAN HARBERDEN", delay: "1.5s" },

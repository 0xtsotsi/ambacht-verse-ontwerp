...
export interface PricingCardBaseProps {
  ...
  featured?: boolean;
  className?: string;
  variant?: 'transparent' | 'grid' | 'breakdown' | 'trust' | 'dutch' | 'builder' | 'mobile' | 'conversion' | 'premium';
}
...
export function PricingCardBase({
  ...
  const variantStyles = {
    transparent: {
      ...
      header: 'bg-gradient-to-r from-sophisticated-green/10 to-elegant-cream/20',
    ...
    trust: {
      ...
      button: 'bg-sophisticated-green hover:bg-sophisticated-green/90 text-white'
    },
    dutch: {

...
export const Testimonials = () => {
  ...
  return (
    <section className="py-32 bg-gradient-to-b from-white to-gray-50 overflow-hidden" ref={sectionRef}>
      <div className="container mx-auto px-16">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-24">
            ...
            >
              <span className="inline-block transition-all duration-700 hover:scale-110 hover:-translate-y-2">WAT ONZE</span><br />
              ...
              >
                <Card className="h-full bg-white/90 backdrop-blur-sm border-terracotta-200/30 hover:bg-white hover:shadow-elegant-panel transition-all duration-700 transform hover:scale-105 hover:-translate-y-2 overflow-hidden">
                    ...
                    {[...Array(testimonial.rating)].map((_, i) => (
                      <Star 
                        ...
                        style={{
                          ...
                          animation: hoveredCard === index ? 'interactive-bounce 1s ease-out' : 'none'
                        }}
                      />
                    ))}
                  ...
                  <blockquote className="text-elegant-grey-700 font-elegant-body text-lg leading-relaxed mb-8 relative z-10 transition-all duration-700 group-hover:text-elegant-dark">
                    <span className="text-terracotta-600 text-2xl mr-2 font-elegant-script">"</span>
                    {testimonial.text}
                    <span className="text-terracotta-600 text-2xl ml-2 font-elegant-script">"</span>
                  </blockquote>
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-12 text-center relative z-10">
              <div className="transform transition-all duration-500 hover:scale-110 hover:-translate-y-2 group">
                <div className="text-5xl md:text-6xl font-elegant-heading text-terracotta-400 mb-3 font-light animate-interactive-pulse-glow">500+</div>
                <div className="text-white/80 font-elegant-body font-light">Tevreden Klanten</div>
              </div>
              <div className="transform transition-all duration-500 hover:scale-110 hover:-translate-y-2 group" style={{animationDelay: '0.1s'}}>
                <div className="text-5xl md:text-6xl font-elegant-heading text-terracotta-400 mb-3 font-light animate-interactive-pulse-glow" style={{animationDelay: '0.2s'}}>15+</div>
                <div className="text-white/80 font-elegant-body font-light">Jaar Ervaring</div>
              </div>
              <div className="transform transition-all duration-500 hover:scale-110 hover:-translate-y-2 group" style={{animationDelay: '0.2s'}}>
                <div className="text-5xl md:text-6xl font-elegant-heading text-terracotta-400 mb-3 font-light animate-interactive-pulse-glow" style={{animationDelay: '0.4s'}}>98%</div>
                <div className="text-white/80 font-elegant-body font-light">Klanten Komen Terug</div>
              </div>
              <div className="transform transition-all duration-500 hover:scale-110 hover:-translate-y-2 group" style={{animationDelay: '0.3s'}}>
                <div className="text-5xl md:text-6xl font-elegant-heading text-terracotta-400 mb-3 font-light animate-interactive-pulse-glow" style={{animationDelay: '0.6s'}}>4.9</div>
                <div className="text-white/80 font-elegant-body font-light">Gemiddelde Score</div>
              </div>
            </div>
          </div>

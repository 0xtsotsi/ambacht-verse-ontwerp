...
export function testThrottling() {
  ...
  console.log(`✅ Throttling test: ${callCount} calls executed out of 100 (expected: 1-5)`);
  return callCount <= 5;
}
...
export function testAnimationFrameOptimization() {
  ...
  console.log(`✅ Animation frame test: ${frameCallCount} frames requested out of 50 (expected: 1)`);

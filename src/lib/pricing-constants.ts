...
export const GUEST_COUNT_RANGES = [
  { min: 10, max: 25, label: 'Intiem', description: 'Perfect voor kleine groepen' },
  { min: 26, max: 50, label: 'Gezellig', description: 'Ideaal voor familiefeesten' },
  ...
  { min: 201, max: 500, label: 'Spectaculair', description: 'Grote evenementen' },
];

...
type AbandonmentData = Record<string, unknown>;
...
export const FUNNEL_DEFINITIONS = {
  booking_flow: [
    {
      stepName: "widget_interaction",
      stepOrder: 1,
      required: true,
      category: "engagement" as const,
    },
    {
      stepName: "date_checker_open",
      stepOrder: 2,
      required: true,
      category: "booking" as const,
    },
    {
      stepName: "date_selection",
      stepOrder: 3,
      required: true,
      category: "booking" as const,
    },
    {
      stepName: "guest_count_selection",
      stepOrder: 4,
      required: true,
      category: "booking" as const,
    },
    {
      stepName: "time_selection",
      stepOrder: 5,
      required: true,
      category: "booking" as const,
    },
    {
      stepName: "booking_form_open",
      stepOrder: 6,
      required: true,
      category: "booking" as const,
    },
    {
      stepName: "form_field_completion",
      stepOrder: 7,
      required: true,
      category: "booking" as const,
    },
  ...
  quote_calculator: [
    {
      stepName: "calculator_open",
      stepOrder: 1,
      required: true,
      category: "quote" as const,
    },
    {
      stepName: "service_category_selection",
      stepOrder: 2,
      required: true,
      category: "quote" as const,
    },
    {
      stepName: "service_tier_selection",
      stepOrder: 3,
      required: true,
      category: "quote" as const,
    },
    {
      stepName: "guest_count_input",
      stepOrder: 4,
      required: true,
      category: "quote" as const,
    },
    {
      stepName: "addon_selection",
      stepOrder: 5,
      required: false,
      category: "quote" as const,
    },
    {
      stepName: "quote_calculation",
      stepOrder: 6,
      required: true,
      category: "quote" as const,
    },
    {
      stepName: "quote_display",
      stepOrder: 7,
      required: true,
      category: "quote" as const,
    },
    {
      stepName: "detailed_quote_request",
      stepOrder: 8,
      required: false,
      category: "quote" as const,
    },
  ...
  date_checker: [
    ...
    {
      stepName: "time_slot_selection",
      stepOrder: 4,
      required: true,
      category: "booking" as const,
    },
    {
      stepName: "availability_confirmation",
      stepOrder: 5,
      required: true,
      category: "booking" as const,
    },
  ...
  contact_form: [
    ...
    {
      stepName: "first_field_interaction",
      stepOrder: 2,
      required: true,
      category: "engagement" as const,
    },
...
class ConversionFunnelManager {
  ...
  public logFunnelStep(
    ...
    UserFlowLogger.interaction(
      ...
      stepName,
      {
        ...
        progressPercentage:
          (session.completedSteps.length / funnelSteps.length) * 100,
      },
      sessionId,
    );
  ...
  public abandonFunnel(
    ...
    const lastCompletedStep =
      session.completedSteps[session.completedSteps.length - 1];
    ...
    const averageCompletionTime =
      completedSessions > 0
        ? relevantSessions
            ...
            .reduce((sum, s) => sum + (s.completionTime || 0), 0) /
          completedSessions
        : 0;
...
export const useConversionFunnel = (
  ...
  const logStep = (stepName: string, stepData?: StepData) => {
    if (sessionId) {
  ...
  const abandon = (
    reason?: "navigation" | "timeout" | "error" | "user_choice" | "unknown",
  ...
  const complete = (conversionData?: ConversionData) => {
    if (sessionId) {

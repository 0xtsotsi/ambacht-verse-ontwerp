...
describe('generateDutchHolidays', () => {
  ...
  const knownEasterDates = [
    { year: 2023, easter: '2023-04-09', easterMonday: '2023-04-10', ascension: '2023-05-18', whitMonday: '2023-05-29' },
    { year: 2024, easter: '2024-03-31', easterMonday: '2024-04-01', ascension: '2024-05-09', whitMonday: '2024-05-20' },
    { year: 2025, easter: '2025-04-20', easterMonday: '2025-04-21', ascension: '2025-05-29', whitMonday: '2025-06-09' },
    { year: 2026, easter: '2026-04-05', easterMonday: '2026-04-06', ascension: '2026-05-14', whitMonday: '2026-05-25' },
    { year: 2027, easter: '2027-03-28', easterMonday: '2027-03-29', ascension: '2027-05-06', whitMonday: '2027-05-17' },
    { year: 2028, easter: '2028-04-16', easterMonday: '2028-04-17', ascension: '2028-05-25', whitMonday: '2028-06-05' },
    { year: 2029, easter: '2029-04-01', easterMonday: '2029-04-02', ascension: '2029-05-10', whitMonday: '2029-05-21' },
    { year: 2030, easter: '2030-04-21', easterMonday: '2030-04-22', ascension: '2030-05-30', whitMonday: '2030-06-10' }
  ];
  ...
  describe('Easter-based Holidays', () => {
    ...
    it('should calculate all Easter-based holidays correctly for known years', () => {
      knownEasterDates.forEach(({ year, easter, easterMonday, ascension, whitMonday }) => {
        const holidays = generateDutchHolidays(year);

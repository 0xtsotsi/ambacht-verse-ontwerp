            ...
            <div className="space-y-24">
              ...
              >
                ...
                <span className="text-terracotta-600 inline-block transition-all duration-700 hover:scale-105 hover:-translate-y-1 relative overflow-hidden">
                  ...
                  {/* Interactive shimmer effect */}
                  <span
                    className="absolute inset-0 -top-full -bottom-full bg-gradient-to-r from-transparent via-terracotta-200/50 to-transparent w-full animate-interactive-shimmer opacity-0 group-hover:opacity-100"
              ...
              >
                Wij proberen ons op een ieder te richten!
                <br />
                Kijk eens rustig rond om inspiratie op
                <br />
                te doen.
              </p>
              ...
              >
                <Button
                  ...
                  onClick={() =>
                    console.log("Button clicked - interactive elegance!")
                  }
                >

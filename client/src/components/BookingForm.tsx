...
export const BookingForm = () => {
  ...
  useLifecycleLogger({
    ...
    props: {
      hasInitialData: Object.values(formData).some((v) => v.length > 0),
    },
  ...
  const { startFunnel, logStep, complete, abandon } =
    useConversionFunnel("contact_form");
    ...
    try {
      ...
      if (isSuccessful) {
        ...
        toast({
          ...
          description:
            "Bedankt voor uw bericht. Wij nemen snel contact met u op.",
        });
  ...
  const handleChange = (field: keyof FormData, value: string) => {
    try {
      ...
      const completedFields = Object.values(updatedData).filter(
        (v) => v.trim().length > 0,
      ).length;
          ...
          >
            ...
            <div className="text-center mb-24 relative z-10">
              ...
              <p className="text-elegant-dark font-elegant-body text-xl leading-relaxed font-light transition-all duration-700 group-hover:text-elegant-grey-700">
                Vul jeje hieg on details en perfeebingxen
                <br />
              ...
              >
                ...
                <div className="text-elegant-dark font-elegant-body text-2xl leading-relaxed font-light transition-all duration-700 group-hover:text-elegant-grey-700">
                  <p className="transform transition-all duration-700 group-hover:translate-x-2">
                    Wesley's Ambacht smoken opstreds traditionele technieken en
                    rijjen logae ingredienten voor de verkoop en frese. In vorms
                    ommen kombaarkaas, hegema- gemaakte brooden en vart visen
                    Minimaal E-numreken gemiddels en we er gaan vred je
                    handelaagr.
                  </p>
                </div>
              </div>

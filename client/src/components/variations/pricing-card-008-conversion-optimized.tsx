...
const PricingCard008ConversionOptimized: React.FC<PricingCardProps> = ({
        ...
        return (
          <div className="bg-green-500 text-white text-center py-2 px-3 rounded-lg mb-3">
            <div className="flex items-center justify-center gap-2">
              ...
              <span className="text-sm font-bold">
                {ct.valueAdd} - {ct.saveToday} {savingsPercentage[serviceType]}
              </span>
            </div>
          </div>
        );
  ...
  return (
    <Card
      className={`relative ${colorScheme.gradient} ${COMMON_STYLES.card} transition-all duration-300 transform hover:scale-105`}
    >
              ...
              {finalPrice ? (
                <div>
                  <div className="flex items-baseline justify-center gap-1">
                    ...
                    <span className="text-5xl font-black text-[#CC5D00]">

...
const pricingOptions: PricingOption[] = [
  {
    ...
    clientTestimonial: {
      quote:
        "Betrouwbaar, lekker en zonder stress. Precies wat je wilt voor een bedrijfsevent.",
  ...
  },
  {
    ...
    clientTestimonial: {
      quote:
        "Ons jubileumfeest was perfect. Het team dacht mee en leverde meer dan beloofd.",
      author: "Jan Smit",
  ...
  },
  {
    ...
    clientTestimonial: {
      quote:
        "Onze gasten praten er nog steeds over. Wereldklasse service in Nederland.",
...
export function TrustFirstPricing({
  className,
  onSelectOption,
}: TrustFirstPricingProps) {
    ...
    <div className={cn("w-full max-w-7xl mx-auto p-6", className)}>
      ...
      <div className="text-center mb-12 space-y-6">
        ...
        <p className="text-xl text-sophisticated-green/80 max-w-3xl mx-auto leading-relaxed">
          Nederlandse waarden: betrouwbaarheid, kwaliteit en eerlijkheid. Daarom
          beginnen wij met onze garanties, niet onze prijzen.
        </p>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12">
        <div className="text-center p-4 bg-white rounded-lg shadow-sm border">
          ...
          <div className="text-sm text-sophisticated-green/70">
            Tevreden Klanten
          </div>
        </div>
        <div className="text-center p-4 bg-white rounded-lg shadow-sm border">
                    ...
                    <div key={index} className="flex items-center gap-3">
                      ...
                      <div className="flex-1">
                        <div className="text-sm font-medium text-deep-charcoal">
                          {signal.title}
                          {signal.metric && (
                            <span className="ml-2 text-sopranos-gold">
                              {signal.metric}
                            </span>
                          )}
                        </div>
                ...
                <div className="bg-elegant-cream/30 p-4 rounded-lg border">
                  <div className="flex items-center gap-1 mb-2">
                    {[...Array(option.clientTestimonial.rating)].map((_, i) => (
                      <Star
                        key={i}
                        className="h-3 w-3 fill-sopranos-gold text-sopranos-gold"
                      />
                    ))}
                  </div>
                  ...
                  <div className="text-xs text-sophisticated-green/60">
                    - {option.clientTestimonial.author},{" "}
                    {option.clientTestimonial.company}
                  </div>
                </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-center gap-2 text-sopranos-gold">
                      ...
                      <span className="text-lg font-medium">
                        Praat direct met onze expert
                      </span>
                    </div>
                    <p className="text-sophisticated-green/80 max-w-2xl mx-auto">
                      Geen chatbots of wachtrijen. Binnen 2 minuten verbonden
                      met een echte expert die uw wensen begrijpt en direct kan
                      adviseren.
                    </p>
                  </div>

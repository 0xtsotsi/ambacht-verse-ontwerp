  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        "organic-natural":
          "0 8px 25px rgba(224, 138, 79, 0.15), 0 3px 10px rgba(0, 0, 0, 0.08)",
        "organic-floating":
          "0 12px 35px rgba(224, 138, 79, 0.12), 0 4px 15px rgba(0, 0, 0, 0.06)",
      },
      keyframes: {
        "accordion-down": {
          from: {
      ...
      animation: {
        ...
        "interactive-pulse-glow":
          "interactive-pulse-glow 3s ease-in-out infinite",

...
test.describe('Accessibility Tests - Floating Booking Widget', () => {
  test('should have no accessibility violations in collapsed state', async ({ page }) => {
    await page.goto('/');
  ...
  test('should have no accessibility violations in expanded state', async ({ page }) => {
    await page.goto('/');
  ...
  test('should support screen readers', async ({ page }) => {
    ...
    const collapsedButton = widget.locator('[aria-label="Reserveer vandaag - Open booking formulier"]').first();
    ...
    const bookingButton = widget.locator('button:has-text("Beschikbaarheid Checken")');
  ...
  test('should have sufficient touch target size', async ({ page }) => {
    ...
    const collapsedButton = page.locator('button:has-text("Reserveer Vandaag")');
  ...
  test('should handle keyboard navigation in both directions', async ({ page }) => {
    await page.goto('/');
    ...
    const currentFocus = await page.evaluate(() => document.activeElement?.getAttribute('aria-label'));

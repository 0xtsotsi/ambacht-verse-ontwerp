...
taskCompletionData.actual_implementation.features_implemented.forEach(feature => {
  console.log(`  🎯 ${feature}`);
});
...
console.log("Use: gh workflow run task-sync.yml -f task_id=task_001_1 -f task_title='Floating Booking Widget Implementation' -f status=done");
